      ...
      <SignedIn>
        <div className="flex">
          ...
          <div className="w-64 bg-white h-screen fixed left-0 border-r border-gray-200">
            <div className="p-4">
              <h1 className="text-2xl font-bold text-purple-600">GenZ Finance</h1>
            </div>
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors ${
                    location.pathname === item.path ? 'bg-purple-50 text-purple-700 border-r-4 border-purple-500' : ''
                  }`}
                >
      ...
      <SignedOut>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Welcome to GenZ Finance</h2>
            ...
            <div className="space-x-4">
              ...
              <Link
                to="/register"
                className="bg-white text-purple-600 px-6 py-2 rounded-lg border border-purple-600 hover:bg-purple-50 transition-colors"
              >
                Register
              </Link>
            </div>
